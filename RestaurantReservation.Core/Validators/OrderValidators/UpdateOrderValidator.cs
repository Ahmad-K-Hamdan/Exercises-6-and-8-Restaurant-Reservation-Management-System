...
namespace RestaurantReservation.Core.Validators.OrderValidators
{
    public class UpdateOrderValidator : AbstractValidator<UpdateOrderDTO>
    {
        ...
        public UpdateOrderValidator(IReservationRepository reservationRepository)
        {
            ...
            RuleFor(x => x)
                ...
                .WithName(nameof(UpdateOrderDTO.OrderDate));
        }

        private async Task<bool> OrderDateMatchesReservationDate(UpdateOrderDTO dto, CancellationToken cancellationToken)
        {
